...
void Bullet::drawBullet(std::array<Tank , 5> &t, int i)
{
	if ( shotEnab )
	{
...
void Bullet::setXYDir(int x,int y,Direction dirBullet)
{
...
void Bullet::setFriendBullet(bool friendBullet)
{
...
void Bullet::setShotEnab(bool shotEnab)
{
